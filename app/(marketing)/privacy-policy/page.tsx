    ...
    <>
      ...
      <LegalPage title="Privacy Policy" lastUpdated="August 5, 2026">
        ...
        <LegalSection title="1. Who we are">
          <p>
            DBLuna is operated by{" "}
            <LegalPlaceholder>[Company Legal Name]</LegalPlaceholder>,
            registered at{" "}
            <LegalPlaceholder>[Registered Business Address]</LegalPlaceholder>.
        ...
        <LegalSection title="4. Who we share data with">
          ...
          <p>
            ...
            process data outside the European Economic Area; where that happens,
        ...
        <LegalSection title="5. How long we keep it">
          <p>
            ...
            active, and diagram content stored on our servers for as long as you
            keep cloud sync enabled for that diagram. You can delete a synced
            diagram, or your account entirely, at any time.
          </p>
        </LegalSection>
        ...
        <LegalSection title="8. Children">
          <p>
            DBLuna is not directed at children under 16, and we do not knowingly
