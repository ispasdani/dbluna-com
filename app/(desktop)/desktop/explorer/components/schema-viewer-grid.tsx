        ...
        return (
            <div className="h-full flex items-center justify-center p-6 bg-background">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm">Loading schema for {tableName}...</p>
                </div>
            </div>
        );
    }
                        ...
                        <Table>
                            <TableHeader className="bg-background sticky top-0 z-10 border-b border-border">
                                <TableRow className="hover:bg-transparent border-none">
                                    ...
                                    <TableHead className="text-xs text-muted-foreground uppercase h-10 px-4">Column Name</TableHead>
                                    <TableHead className="text-xs text-muted-foreground uppercase h-10 px-4">Data Type</TableHead>
                                    <TableHead className="text-xs text-muted-foreground uppercase h-10 px-4">Max Length</TableHead>
                                    <TableHead className="text-xs text-muted-foreground uppercase h-10 px-4">Allow Nulls</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {columns.map((col, i) => (
                                    <TableRow key={i} className="border-border/50 hover:bg-accent/30 transition-colors">
                                        ...
                                        <TableCell className="whitespace-nowrap text-foreground py-3 px-4 font-medium">
                                            {col.COLUMN_NAME}
                                        </TableCell>
                                        <TableCell className="whitespace-nowrap text-blue-400 py-3 px-4">
                                            {col.DATA_TYPE}
                                        </TableCell>
                                        <TableCell className="whitespace-nowrap text-muted-foreground py-3 px-4">
