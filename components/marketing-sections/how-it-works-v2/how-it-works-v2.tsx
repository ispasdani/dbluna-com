...
import { PixelatedCanvas } from "@/components/marketing-general/pixelated-canvas";
import { ShieldIcon } from "@/components/uiJsxAssets/shield-icon";
...
export const HowItWorksV2 = () => {
  const tabs = [
    ...
    {
      title: "Catch Issues Before You Ship",
      description:
        "The built-in linter flags duplicate tables, reserved keywords, orphaned tables, and FK type mismatches as you design.",
      icon: ShieldIcon,
      id: "issues",
      skeleton: <IssuesFeedSkeleton />,
    },
  ];
    ...
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <div className="border-divide divide-divide mt-16 hidden w-full grid-cols-2 divide-x border-t lg:grid">
          ...
          <div className="relative h-full max-h-92.5 overflow-hidden bg-[radial-gradient(var(--color-dots)_1px,transparent_1px)] mask-r-from-90% mask-l-from-90% mask-radial-from-20% [background-size:10px_10px]">
