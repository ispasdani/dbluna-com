...
>) => {
  ...
  return (
    <Component
      {...props}
      className={cn(
        "block rounded-xl px-6 py-2 text-center text-sm font-medium transition duration-150 active:scale-[0.98] sm:text-base hover:bg-charcoal-700 hover:dark:bg-neutral-300",
        variant === "primary"
